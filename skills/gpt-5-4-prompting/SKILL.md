...
description: Internal guidance for composing Codex and GPT-5.4 prompts for coding, review, diagnosis, and research tasks inside the Codex OpenCode plugin
user-invocable: false
---

# GPT-5.4 Prompting

Use this skill when the `codex-rescue` subagent needs to ask Codex or another GPT-5.4-based workflow for help.
