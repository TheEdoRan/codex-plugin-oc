# @theedoran/codex-plugin-oc

## 0.1.0

### Minor Changes

- [`836a520`](https://github.com/TheEdoRan/codex-plugin-oc/commit/836a520eef6559aab5a232b53c322fa89ac134db) Thanks [@TheEdoRan](https://github.com/TheEdoRan)! - Port the plugin from Claude Code to OpenCode as `@theedoran/codex-plugin-oc`.
